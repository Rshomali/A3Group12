...
public class Console
{
	...
	public Console( String EvmIpAddress )
	{
			...
			{   // Here, the main thread continues and provides the main menu
				...
				if ( Option.equals( "2" ) )
				{
					...
					{	
						...
						{
							Error = false;
							evt = new Event( EventIDs.MOTION_ID, Events.SIMULATE_WINDOW_BROKEN );
	...
	//////////// option 3 ////////////
				if ( Option.equals( "3" ) )
				{
					...
					{	
						...
						{
							Error = false;
							evt = new Event( EventIDs.MOTION_ID, Events.SIMULATE_MOTION_DETECTED );
	...
	//////////// option 4 ////////////
				if ( Option.equals( "4" ) )
				{
					...
					{	
						...
						{
							Error = false;
							evt = new Event( EventIDs.MOTION_ID, Events.SIMULATE_FIRE_ALARM );
	...
	//////////// option 5 ////////////
				if ( Option.equals( "5" ) )
				{
					...
					{	
						...
						{
							Error = false;
							evt = new Event( EventIDs.MOTION_ID, Events.ARM_SYSTEM );
	...
	//////////// option 6 ////////////
				if ( Option.equals( "6" ) )
				{
					...
					{	
						...
						{
							Error = false;
							evt = new Event( EventIDs.MOTION_ID, Events.DISARM_SYSTEM );
